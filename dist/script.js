...
Object(_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])(".container1", "2021-12-31");
Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])(".glazing_slider", ".glazing_block", ".glazing_content", "active");
Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])(".decoration_slider", ".no_click", ".decoration_content > div > div", "after_click"); // const modalBtn = document.querySelector(".popup_engineer_btn"),
...
function timer(selector, deadline) {
  function getTimeCalculating(deadline) {
    var deadTime = Date.parse(deadline) - Date.now(),
  ...
  function setTimer(selector, deadline) {
    ...
    function updateTimer() {
      var t = getTimeCalculating(deadline);
