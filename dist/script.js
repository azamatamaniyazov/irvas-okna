...
var modalBtn = document.querySelector(".popup_engineer_btn"),
...
function closeModal(modalSelector) {
  ...
  modalSelector.querySelector(".popup_close").addEventListener("click", function () {
    hideModal();
  });
...
closeModal(modalWindow); // modalBtn.addEventListener("click", () => {
...
callBtn.forEach(function (elem) {
  openModal(elem, callModal); //   elem.addEventListener("click", (e) => {
  //     e.preventDefault();
